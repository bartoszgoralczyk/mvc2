...
namespace Framework
{
    ...
    class Controller extends Base
    {
        ...
        * @readwrite
        */
        protected $_defaultLayout = "layouts/boot";
        ...
        */
        ...
        {
            return new Exception\Argument("Nieprawidłowy argument");
        }
        ...
        public function render()
        {
            ...
            {
                throw new View\Exception\Renderer("Nieprawidłowa składnia układu/szablonu");
            }
        }
