...
namespace Framework
{
    ...
    class Base
    {
        ...
        public function __call($name, $arguments)
        {
            ...
            {
                throw new Exception("Wywołaj parent::__construct!");
            }
        ...
        {
            return new Exception\ReadOnly("Własność {$property} jest tylko do odczytu");
        }
        
        protected function _getExceptionForWriteonly($property)
        {
            return new Exception\WriteOnly("Własność {$property} jest tylko do zapisu");
        }
        
        protected function _getExceptionForProperty()
        {
            return new Exception\Property("Nieprawidłowa własność");
        }
        
        protected function _getExceptionForImplementation($method)
        {
            return new Exception\Argument("Metoda {$method} nie jest zaimplementowana");
        }
    }    
}